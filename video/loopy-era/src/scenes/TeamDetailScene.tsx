...
const COL_HEADERS = ["P0 Analyze", "P1 Design", "P2 Database", "P3 Implement", "P4 QA", "P5 Ship"];
...
export const TeamDetailScene = () => {
  ...
  // Pulse animation for Phase 3 parallel cells (Frontend + Backend)
  ...
  return (
    <AbsoluteFill style={{ background: colors.bg, fontFamily: sans }}>
      ...
      {/* Phase 3 "parallel" bracket/annotation */}
      {(() => {
      ...
      >
        <div style={{ fontSize: 14, color: colors.muted }}>
          Phase 3 parallelizes Frontend + Backend — cutting delivery time in half
        </div>
      </div>
    </AbsoluteFill>
  );
